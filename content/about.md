...
lastmod: 2026-05-23T01:18:00+08:00
...
热烈欢迎以绘画练习为目的的非恶意无偿，不论水平高低！

在该网站所发布的所有OC稿件均为受版权保护的专属定制稿件，未经许可严禁作商业用途！

**严禁**将我所发布的OC稿件在任何提供图像生成AI的服务中使用，这是一种对画师工作成果的侵权！

- 关于技术项目:

有关代码、原理图和资料在github上开源，可自由下载。

*浏览网站的其他内容视为同意此声明。若不同意，请停止访问。*
...
### STATEMENTS TO THE CONTENTS

- ABOUT COMMISSION:

Commissions posted on this website are copyright-protected. Uses for commercial purpose are prohibited.

DO NOT use any of my commissions for AI image-generating/modifying services. This is considered a tort for artists.

- ABOUT PROJECTS:

Relevant code, schematics and other documents can be found on GitHub.

*Browsing other contents on the website is considered agreement with this statement.*
